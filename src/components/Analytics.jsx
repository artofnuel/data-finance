    ...
    <div className='w-full bg-white py-16 px-4'>
        <div className="max-w-5xl mx-auto grid gap-4 justify-center items-center md:grid-cols-2">
            ...
            <div className='p-4 flex flex-col justify-center'>
                ...
                <h2 className='text-bkg font-bold text-2xl md:text-4xl py-2'>Manage Data Analytics Centrally</h2>
                ...
                <button className='text-primary bg-bkg w-[200px] rounded text font-semibold p-3 my-3'>Get Started</button>
            </div>
        </div>
    </div>
  )
